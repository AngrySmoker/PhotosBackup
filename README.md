...
Latest release: **0.4.0** ([releases](https://github.com/AngrySmoker/PhotosBackup/releases)).
142 tests run on an iPhone simulator: 140 pass, with 2 opt-in live tests
skipped.

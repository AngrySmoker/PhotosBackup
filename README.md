...
Latest release: **0.4.1** ([releases](https://github.com/AngrySmoker/PhotosBackup/releases)).
145 tests run on an iPhone simulator: 143 pass, with 2 opt-in live tests
skipped.
